	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource() == btnInsereInicio) {
			...
			if(iN == lista.viewHead()){
				JOptionPane.showMessageDialog(null, "O número foi adicionado no inicio da lista");
			}
		...
		if(e.getSource() == btnInsereFinal) {
			...
			if(iN == lista.viewTail()){
				JOptionPane.showMessageDialog(null, "O número foi adicionado no final da lista");
			}
